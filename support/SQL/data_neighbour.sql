CREATE TABLE `data_neighbour` (
	`neighbourhood` VARCHAR(100) NOT NULL COLLATE 'utf8_general_ci',
	`norm_neighbourhood` VARCHAR(100) NOT NULL COLLATE 'utf8_general_ci',
	`area` DECIMAL(20,3) UNSIGNED NOT NULL DEFAULT '0.000',
	...
	`mean_revenue_house` DECIMAL(20,3) UNSIGNED NOT NULL DEFAULT '0.000',
